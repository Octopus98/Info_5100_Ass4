...
public class Weighted {
    public static void main(String[] args) {
        ...
        //Receive the total number of assignments
        System.out.println("Please input the total number of your assignments (should be a positive integer):");
        Scanner scanNum = new Scanner(System.in);
        num = scanNum.nextInt();
        System.out.println("The number of assignments you input is: " + num);
...
//        while (scanPoint.hasNextLine()) {
        ...
        if (totalInput.length != num) System.out.println("Please check your input!");   //check if the input correspond to the number of assignments.
